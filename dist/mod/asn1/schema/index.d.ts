...
export declare namespace Autoguard {
    const Guards: {
        Node: autoguard.serialization.MessageGuard<{
        ...
        BitString: autoguard.serialization.MessageGuard<{
            kind: "UNIVERSAL";
            form: "PRIMITIVE";
            type: "BIT_STRING";
            data: string;
        }>;
        Integer: autoguard.serialization.MessageGuard<{
            kind: "UNIVERSAL";
            form: "PRIMITIVE";
            type: "INTEGER";
            data: string;
        }>;
        Null: autoguard.serialization.MessageGuard<{
            kind: "UNIVERSAL";
            form: "PRIMITIVE";
            type: "NULL";
            data: string;
        }>;
        ObjectIdentifier: autoguard.serialization.MessageGuard<{
            kind: "UNIVERSAL";
            form: "PRIMITIVE";
            type: "OBJECT_IDENTIFIER";
            data: string;
        }>;
        OctetString: autoguard.serialization.MessageGuard<{
            kind: "UNIVERSAL";
            form: "PRIMITIVE";
            type: "OCTET_STRING";
            data: string;
        }>;
        Sequence: autoguard.serialization.MessageGuard<{
            kind: "UNIVERSAL";
            form: "CONSTRUCTED";
            type: "SEQUENCE";
        ...
        Set: autoguard.serialization.MessageGuard<{
            kind: "UNIVERSAL";
            form: "CONSTRUCTED";
            type: "SET";
            data: autoguard.guards.Array<{
        ...
        UTF8String: autoguard.serialization.MessageGuard<{
            kind: "UNIVERSAL";
            form: "PRIMITIVE";
            type: "UTF8_STRING";
            data: string;
        }>;
        Date: autoguard.serialization.MessageGuard<{
            kind: "UNIVERSAL";
            form: "PRIMITIVE";
            type: "DATE";
            data: string;
        }>;
        UTCTime: autoguard.serialization.MessageGuard<{
            kind: "UNIVERSAL";
            form: "PRIMITIVE";
            type: "UTC_TIME";
            data: string;
