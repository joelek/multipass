...
declare function convertJSONToBase64URLString(json: any): Promise<string>;
declare function convertBase64URLStringToJSON(string: string): Promise<any>;
...
export { convertJSONToString, convertJSONToBase64URLString, convertBase64URLStringToJSON, convertStringToJSON, convertUTF8BufferToString, convertStringToUTF8Buffer, convertBufferToBase64String, convertBase64StringToBuffer, convertBufferToBase64URLString, convertBase64URLStringToBuffer, convertStringToBase64String, convertBase64StringToString, convertStringToBase64URLString, convertBase64URLStringToString };
