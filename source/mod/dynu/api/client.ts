...
export const makeClient = (clientOptions?: autoguard.api.ClientOptions): Client => ({
	"listDomains": async (request, requestOptions) => {
	...
	"listDomainRecords": async (request, requestOptions) => {
	...
	"createDomainRecord": async (request, requestOptions) => {
	...
	"updateDomainRecord": async (request, requestOptions) => {
	...
	"deleteDomainRecord": async (request, requestOptions) => {
